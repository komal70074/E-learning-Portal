    ...
    try:
        if request.session['rollno']!=None:
            ...
            if request.method=='POST':
                ...
                sr=Sturesponse(rollno=rollno,name=name,program=program,branch=branch,year=year,subject=subject,contactno=contactno,emailaddress=emailaddress,responsetype=responsetype,responsetext=responsetext,responsedate=responsedate)
                sr.save()
                messages.success(request,"Response Submit Successfully")
